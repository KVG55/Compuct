Public Class Shape
    ...
    Private ReadOnly shapeType()() As Point = {New Point() {New Point(10, -1), New Point(10, -2), New Point(10, -3), New Point(11, -2)},
    ...
    Private ReadOnly rotationOffsets As New Dictionary(Of Integer, Point()())

    Private ReadOnly _xType As Integer
    Private ReadOnly _shapeColor As String
